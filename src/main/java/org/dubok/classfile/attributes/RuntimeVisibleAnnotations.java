...
public final class RuntimeVisibleAnnotations extends Attribute {

    public final Annotation[] annotations;

    RuntimeVisibleAnnotations(Constant[] constantPool, int attributeNameIndex, final DataInput dataInput) throws IOException {
    ...
    public void print(PrintStream printStream, String indent)  {
        printStream.println(indent + "Attribute (RuntimeVisibleAnnotations) attributeNameIndex = " + attributeNameIndex);
        indent += dumpIndent;
