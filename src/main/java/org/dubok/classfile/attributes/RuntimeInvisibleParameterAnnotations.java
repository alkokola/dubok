...
public final class RuntimeInvisibleParameterAnnotations extends Attribute {
    ...
    class ElementValue implements Printable {
        ...
        int  valueIndex2;              // valueType = e enumTypeNameIndex
        ...
        ElementValue(DataInput dataInput) throws IOException {
            ...
            switch (valueType) {
                ...
                case 'e':
                    valueIndex = dataInput.readUnsignedShort();
                    valueIndex2 = dataInput.readUnsignedShort();
                    break;
                case '@':
        ...
        public void print(PrintStream printStream, String indent) {
            ...
            switch (valueType) {
                ...
                case 'e':
                    constantPool[valueIndex].print(printStream, indent);
                    constantPool[valueIndex2].print(printStream, indent);
                    break;
                case '@':
    ...
    RuntimeInvisibleParameterAnnotations(Constant[] constantPool, int attributeNameIndex, final DataInput dataInput ) throws IOException {
    ...
    @Override
    public void print(PrintStream printStream, String indent)  {
        printStream.println(indent + "Attribute (RuntimeInvisibleParameterAnnotations) attributeNameIndex = " + attributeNameIndex);
        indent += dumpIndent;
